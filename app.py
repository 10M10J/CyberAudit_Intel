...
def main():
    ...
    st.sidebar.caption("Discover CyberAudit Intel, revolutionizing cybersecurity audit report analysis with advanced NLP and AI. Effortlessly upload unstructured audit reports for in-depth analysis and actionable insights. Streamline your decision-making process by obtaining real-time answers to critical questions. Leverage our AI-powered chatbot for instant support and enhanced clarity. Your security decisions, simplified!")
